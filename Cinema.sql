...
GO
ALTER TRIGGER Trig_TicketOnBill_Insert ON dbo.TicketOnBill
FOR INSERT, UPDATE
AS
BEGIN
	...
	WHERE TB.BillID IN (SELECT TOP 1 BillID FROM Inserted); 
...
SELECT * FROM dbo.MovieOnType;
--ShowTimes
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('',DEFAULT,'',GETDATE(),NULL);
...
GO
--------------------------------------------------------------------------------------------------
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('404CND',DEFAULT,'RCG001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('BDTH',DEFAULT,'RCG001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CNBX',DEFAULT,'RCG001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CTBL',DEFAULT,'RCG001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KRAVEN',DEFAULT,'RCG001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KVH',DEFAULT,'RCG001',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LDBCPS',DEFAULT,'RCG001',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LM',DEFAULT,'RCG001',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('MOANA2',DEFAULT,'RCG001',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('SONIC3',DEFAULT,'RCG001',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('VUAST',DEFAULT,'RCG001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('404CND',DEFAULT,'RCG002',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('BDTH',DEFAULT,'RCG002',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CNBX',DEFAULT,'RCG002',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CTBL',DEFAULT,'RCG002',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KRAVEN',DEFAULT,'RCG002',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KVH',DEFAULT,'RCG002',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LDBCPS',DEFAULT,'RCG002',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LM',DEFAULT,'RCG002',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('MOANA2',DEFAULT,'RCG002',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('SONIC3',DEFAULT,'RCG002',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('VUAST',DEFAULT,'RCG002',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('404CND',DEFAULT,'RCG003',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('BDTH',DEFAULT,'RCG003',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CNBX',DEFAULT,'RCG003',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CTBL',DEFAULT,'RCG003',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KRAVEN',DEFAULT,'RCG003',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KVH',DEFAULT,'RCG003',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LDBCPS',DEFAULT,'RCG003',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LM',DEFAULT,'RCG003',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('MOANA2',DEFAULT,'RCG003',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('SONIC3',DEFAULT,'RCG003',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('VUAST',DEFAULT,'RCG003',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('404CND',DEFAULT,'RLT001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('BDTH',DEFAULT,'RLT001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CNBX',DEFAULT,'RLT001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CTBL',DEFAULT,'RLT001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KRAVEN',DEFAULT,'RLT001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KVH',DEFAULT,'RLT001',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LDBCPS',DEFAULT,'RLT001',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LM',DEFAULT,'RLT001',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('MOANA2',DEFAULT,'RLT001',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('SONIC3',DEFAULT,'RLT001',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('VUAST',DEFAULT,'RLT001',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('404CND',DEFAULT,'RLT002',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('BDTH',DEFAULT,'RLT002',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CNBX',DEFAULT,'RLT002',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CTBL',DEFAULT,'RLT002',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KRAVEN',DEFAULT,'RLT002',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KVH',DEFAULT,'RLT002',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LDBCPS',DEFAULT,'RLT002',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LM',DEFAULT,'RLT002',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('MOANA2',DEFAULT,'RLT002',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('SONIC3',DEFAULT,'RLT002',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('VUAST',DEFAULT,'RLT002',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('404CND',DEFAULT,'RLT003',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('BDTH',DEFAULT,'RLT003',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CNBX',DEFAULT,'RLT003',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('CTBL',DEFAULT,'RLT003',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KRAVEN',DEFAULT,'RLT003',DATEADD(DAY,1,GETDATE()),NULL);
INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('KVH',DEFAULT,'RLT003',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LDBCPS',DEFAULT,'RLT003',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('LM',DEFAULT,'RLT003',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('MOANA2',DEFAULT,'RLT003',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('SONIC3',DEFAULT,'RLT003',DATEADD(DAY,1,GETDATE()),NULL);
--INSERT INTO dbo.ShowTimes(MovieID,ShiftID,RoomID,Date,EndTime)VALUES('VUAST',DEFAULT,'RLT003',DATEADD(DAY,1,GETDATE()),NULL);

DELETE FROM dbo.Account WHERE RoleID <> 'QL'